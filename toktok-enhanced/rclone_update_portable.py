...
RCLONE_BIN = str(RCLONE_DIR / 'rclone.exe')  # Portable: panggil rclone.exe lokal
RCLONE_CONFIG = str(RCLONE_DIR / 'rclone.conf')
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_DIR / 'uploader_portable.log'),
...
def upload_with_rclone(local_path):
    ...
    rclone_log_file = LOG_DIR / "rclone_all_portable.log"
...
def main():
    logger.info("=== RCLONE UPLOADER PORTABLE MODE ===")
